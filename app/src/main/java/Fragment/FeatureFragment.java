                        ...
                        try {
                            ...
                            for(int i=0;i<ja.length();i++)
                            {
                                ...
                                if(jo.isNull("category")){
                                    JSONObject categoryTemp = new JSONObject();
                                    categoryTemp.put("name", "Toán tin");
                                    categoryTemp.put("_id", "5f66f8bc877b74b5e133db8c");
                                    jo.put("category", categoryTemp);
                                    //Log.v("Category", jo.getJSONObject("category").getString("name"));
                                }else if(jo.isNull("discount")){
                                    //Log.v("Discount", "is null");
                                    jo.put("discount", "0");
                                }
